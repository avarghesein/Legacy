	...
	a new database(directory sdbase will be created if necessory). You can reassign a database by first deleting  item 'OT'
	from windows-registry and rerunning OpTech. In this case first you must specify database requirements all over 
	again.
