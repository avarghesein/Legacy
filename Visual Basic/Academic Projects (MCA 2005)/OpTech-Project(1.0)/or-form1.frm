...
Begin VB.Form or_form1 
   ...
   Begin VB.Menu mtools 
      ...
      Begin VB.Menu tdc 
         ...
         Shortcut        =   +^{F2}
      End
      Begin VB.Menu sepcalc 
         Caption         =   "-"
      End
      Begin VB.Menu Scientech1_0 
...
Private Sub Scientech1_0_Click()
On Error GoTo xit
    
    Call Shell(App.path + "\ScienTech.1.0.EXE", vbNormalFocus)

Exit Sub
xit:
  Call MsgBox("Can't locate ScienTech.1.0.EXE.", vbOKOnly, "OpTech.1.0")
End Sub
