...
public:
   ...
   ~CConsoleProcess(void);
	...
	bool Start(CTString tsExePath,CTString tsCmdLineArgs = CTString::NullString(),bool IsRedirect = true);
	bool Kill(void);
...
bool CConsoleProcess::Start(CTString tsExePath,CTString tsCmdLineArgs,bool IsRedirect)
{  
	...
	bool bRet =  CreateProcess(0,(TCHAR*)tsDosShell,0,0,true,(IsNTplatform() ? CREATE_NEW_CONSOLE : 0 ) | CREATE_NEW_PROCESS_GROUP,0,(TCHAR*)CurDir,&msi,&mpi) != 0;
