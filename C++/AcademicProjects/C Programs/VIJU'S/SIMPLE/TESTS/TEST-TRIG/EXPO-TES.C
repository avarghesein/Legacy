//----checking the effficiencies of 'e' from mat.c from sourse,and
//--exp from math.h,from tc lib-------//
#include<math.h>
...
for(c=0,i=a;i<=b;c++,i+=s) x[c]=e(i),y[c]=exp(i);
