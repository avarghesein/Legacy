...
#include "..\WinMonitorCLIB.1.0\NetworkDatatypes.h"
#include "..\WinMonitorCLIB.1.0\NetworkHeaderFormats.h"
#include "..\WinMonitorCLIB.1.0\GenericExtendedQueue.h"
#include "..\WinMonitorCLIB.1.0\GenericUtility.h"

#include "..\WinMonitorCLIB.1.0\GenericNetwork.h"
#include "..\WinMonitorCLIB.1.0\TcpNetworkMonitorDataSocket.h"
#include "..\WinMonitorCLIB.1.0\TcpNetworkMonitorListener.h"
#include "..\WinMonitorCLIB.1.0\LzssCompression.h"


#include "..\WinMonitorCLIB.1.0\GenericCommandMonitorUtility.h"
#include "..\WinMonitorCLIB.1.0\exeExtraEditor.h"
#include "..\WinMonitorCLIB.1.0\WinMonitorXmlUtility.h"
...
int APIENTRY _tWinMain(HINSTANCE hInst,HINSTANCE hPreInst,LPTSTR lpCmdLine,int nCmdShow)
{
	...
	if(!IsXMLexists()) if(!ExtractXMLfromEXE()) return false;
*/
	...
	if(!LoadWinMonitorServerConfigurationFromXml(gbl_struct_WinMonitorServerConfig)) return 0;
