...
class CChatServer:public CGeneralMemoryUtility,public CNetworkBasicUtility 
{
	...
	public:
		static CExtendedLinkedList<void> gbl_lnkdlst_ChatClients;
	...
	public:
		...
		static GetExitMessage(void) { return m_wQuitMessage; }
        CChatServer(void);
	   ~CChatServer();
};

CExtendedLinkedList<void> CChatServer::gbl_lnkdlst_ChatClients;
