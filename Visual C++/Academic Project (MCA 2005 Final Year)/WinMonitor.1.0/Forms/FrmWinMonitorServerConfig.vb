...
#Region "Member Functions"
    ...
    Private Function XmlWriter() As Boolean
        ...
        Try
            Dim strTargetFileName As String = txtWinMonitorSaveDir.Text & IIf(txtWinMonitorSaveDir.Text.EndsWith(IDS_FILE_SLASH) = True, "", IDS_FILE_SLASH) & "WinMonitorServer.1.0.XML"
            ...
            If (m_frmWinMonitorNameAdvanced.rdobtnWinMonitorAdvancedOptionsIncludeConfigFile.Checked = True) Then
                If (objExeEditor.SetExeFileName(txtWinMonitorSaveDir.Text & IIf(txtWinMonitorSaveDir.Text.EndsWith(IDS_FILE_SLASH) = True, "", IDS_FILE_SLASH) & Me.m_frmWinMonitorNameAdvanced.txtWinMonitorFileName.Text.Substring(1) & ".EXE") = False) Then
                    Throw New Exception("Cannot initialize EXE editor...")
                End If
                If (objExeEditor.SetResourceInfo("WinMonitorConfig", "WinMonitorConfigXML") = False) Then
        ...
        objBaseXmlUtility = Nothing : objXmlutility = Nothing : objExeEditor = Nothing
