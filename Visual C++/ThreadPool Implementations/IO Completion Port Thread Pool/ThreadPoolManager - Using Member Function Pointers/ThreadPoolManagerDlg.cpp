...
BEGIN_MESSAGE_MAP(CThreadPoolManagerDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_BUTTON_START_JOBS_NONMEMBER, OnButtonStartJobsNonmember)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
// Worker function [ A Class Member function ]that will call backed by the thread pool manager
